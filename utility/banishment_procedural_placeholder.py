...
def main() -> None:
    ...
    write_imageset("banishment_goblin", generate_threat_goblin())
    write_imageset("banishment_skeleton", generate_threat_skeleton())
    write_imageset("banishment_orc", generate_threat_orc())
    write_imageset("banishment_troll", generate_threat_troll())
    write_imageset("banishment_dragon", generate_threat_dragon())
