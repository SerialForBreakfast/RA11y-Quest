...
|---|---|---|---|---|---|---|
| error | requiredTextMissing | deleteAlert | Required text `Cancel` was not found. | Expected instructional or identifying copy was not detected in the screenshot evidence. | Open the referenced PNG and confirm whether the copy is absent, clipped, localized differently, or missing from OCR. | 10:41 Files Delete saved project? This action removes the local copy fr.... Delete |
